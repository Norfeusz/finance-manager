					...
					{aiStatus.status === 'connected' && (
						<>
							...
							<div className='ai-buttons-container'>
								<button onClick={generateReport} disabled={isLoading || isTxtLoading} className='ai-btn ai-btn-primary'>
					...
					{aiStatus.status === 'not_configured' && (
						<div className='ai-setup-instructions'>
							...
							<div className='ai-info-box'>
								<strong>💡 Wskazówka:</strong> Raporty AI analizują wspólne finanse Gabi i Norf, dając praktyczne porady
								dla zarządzania budżetem jako para.
							</div>
						</div>
					)}
